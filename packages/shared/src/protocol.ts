 ...
 *
 * The server streams typed events over SSE (`AskEvent`, `AutopilotEvent`, …)
 * and the client applies each to the tldraw store — creating shapes, streaming
 * text deltas into them, filling table cells and map pins. See
